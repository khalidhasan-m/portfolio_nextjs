...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-16 sm:py-20 lg:py-24 dark:bg-white/[0.01] bg-black/[0.01] cq-section">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 min-w-0">
        ...
        {/* Container-query driven grid: 1 → 2 → 3 cols by container width */}
        <div ref={ref} className="section-fade cq-grid">
          <div className="cq-cols">
            {projects.map((project) => (
              <div
                key={project.id}
                className="project-card cq-card group rounded-2xl overflow-hidden dark:bg-white/5 bg-white/90 border dark:border-white/10 border-black/8 dark:hover:border-amber-500/30 hover:border-amber-500/30 transition-all duration-300"
              >
